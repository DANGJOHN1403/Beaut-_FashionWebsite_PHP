...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>Đăng ký</h3>
      <input type="text" name="name" required placeholder="Tên đăng nhập" class="box" maxlength="50">
      <input type="email" name="email" required placeholder="Emai" class="box" maxlength="50" oninput="this.value = this.value.replace(/\s/g, '')">
      <input type="text" name="number" required placeholder="SDT" class="box" min="0" max="9999999999" maxlength="10">

...
<section class="orders">
   ...
   <div class="box">
      ...
      <p>Tổng tiền : <span><?= $fetch_orders['total_price']; ?>VND</span></p>
      <p> Tình trạng đơn hàng : <span style="color:<?php if($fetch_orders['payment_status'] == 'Đang xử lý'){ echo 'red'; }else{ echo 'green'; }; ?>"><?= $fetch_orders['payment_status']; ?></span> </p>
   </div>
   <?php
      }
      }else{
